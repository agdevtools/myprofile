        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">Armand Gaillard</a></h1>
              <span className="email"><i className="icon-mail"></i> armand_gaillard@hotmail.com</span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                <li><a href="https://www.facebook.com/armand.gaillard" target="_blank" rel="noopener noreferrer"><i className="icon-facebook2" /></a></li>
                <li><a href="https://twitter.com/saboteur78" target="_blank" rel="noopener noreferrer"><i className="icon-twitter2" /></a></li>
